...
// the height of the walls, plus half the height of the roof for the position
roof.position.y = 2.5 + 0.5;
// rotate the roof 1/8th
...
// half the depth of the walls (produces z fighting)
...
for (let i = 0; i < 50; i++) {
    ...
    // when you use the same angle on sin and cos, you get a position in a circle
